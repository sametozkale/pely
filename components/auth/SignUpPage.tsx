...
import { signUpWithEmail, signInWithGoogle, signInWithGitHub } from '../../services/authService';
...
const SignUpPage: React.FC<SignUpPageProps> = ({ onClose, onSignInClick, onSuccess }) => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      toast.success('Signed in with Google successfully!', {
        description: 'Welcome to Pely AI!',
        duration: 3000,
      });
      // OAuth sign-in automatically signs the user in, so redirect to home
      setTimeout(() => {
        navigate('/');
      }, 1000);
    } catch (err: any) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4 font-sans">
      ...
      >
        <div className="bg-card border border-border rounded-2xl shadow-xl p-8 relative">
          ...
          <h2 className="text-2xl font-semibold mb-2 font-display">Create Account</h2>
